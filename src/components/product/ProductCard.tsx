...
export type ProductCardData = {
  ...
  variants: {
    ...
    name: string;
    price: number;
    inventory?: { onHand: number; reserved: number; trackInventory: boolean } | null;
  }[];
...
export function ProductCard({
  ...
  priority?: boolean;
  className?: string;
  /** When provided, the card offers a quick-view button on hover/focus. */
    ...
    >
      <div className="relative aspect-4/5 overflow-hidden bg-gradient-to-b from-cream-50 to-cream-200">
        ...
        <div className="pointer-events-none absolute left-4 top-4 z-10 flex flex-col items-start gap-1.5">
          ...
          {inStock && product.isBestSeller ? <Badge tone="leaf">Bestseller</Badge> : null}
          ...
          {onQuickView ? (
            ...
            >
              <svg width="15" height="15" viewBox="0 0 20 20" fill="none" aria-hidden>
                ...
                <path d="M13.5 13.5L17 17M9 6.5v5M6.5 9h5" stroke="currentColor" strokeWidth="1.4" />
              </svg>
            </button>
          ) : null}
        </div>
