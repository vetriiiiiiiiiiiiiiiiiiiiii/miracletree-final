          ...
          {activity.length === 0 ? (
            ...
            <ul className="divide-y divide-border-subtle">
              {activity.map((entry) => (
                <li
                  key={entry.id}
                  className="flex flex-wrap items-baseline gap-3 px-5 py-3"
                >
            ...
            >
              <div className="grid gap-5">
                ...
                {POLICIES.map((policy) => (
                  <div
                    key={policy.key}
                    className={cn(policyKey !== policy.key && "hidden")}
                  >
                    <input
                      type="hidden"
