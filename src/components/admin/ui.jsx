  ...
  return (
    <header className="mb-9">
      ...
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div>
          <h1
            className="text-[1.9rem] leading-tight text-cream-50"
...
export function StatCard({ label, value, delta, hint, href, tone = "default" }) {
  ...
  const body = (
    <>
      ...
      <p className="mt-3 text-[1.85rem] leading-none tabular-nums text-cream-50">
        {value}
      </p>
...
export function FieldGroup({ title, description, children, className }) {
  return (
    <fieldset
      className={cn(
        "grid gap-5 border-t border-border-subtle pt-7 first:border-t-0 first:pt-0",
        className,
      )}
    >
