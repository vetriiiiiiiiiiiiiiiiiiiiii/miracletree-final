...
function Glyph({ name }: { name: "leaf" | "bag" | "search" | "heart" }) {
  const paths = {
    leaf: (
      <>
    ...
    heart: <path d="M20 33s-13-8.2-13-17.6A7.6 7.6 0 0 1 20 11a7.6 7.6 0 0 1 13 4.4C33 24.8 20 33 20 33z" />,
  };
