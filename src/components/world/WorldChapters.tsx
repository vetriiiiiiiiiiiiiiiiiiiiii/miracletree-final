...
import type { ChapterState } from "@/lib/world/MoringaScene";
...
export function WorldChapters({
  ...
  const onChapter = useCallback((state: ChapterState) => {
                ...
                {isFinal && index === active ? (
                  <div className="pointer-events-auto mt-10">
                    <LinkButton
                      ...
                      size="lg"
                      magnetic
                      onClick={() => analytics.ctaClick("Shop the collection", "world-final")}
                    >
                      Shop the collection
                    </LinkButton>
                  </div>
