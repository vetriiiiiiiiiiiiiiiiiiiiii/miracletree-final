            ...
            <li key={option.value}>
              ...
              >
                ...
                {option.count !== undefined ? (
                  <span className="text-xs tabular-nums text-cream-400">{option.count}</span>
                ) : null}
              </button>
            </li>
          );
    ...
    <label className="flex cursor-pointer items-center justify-between gap-4 text-sm text-cream-300">
      ...
      <button
        ...
        className={cn(
          ...
          checked ? "border-emerald-400 bg-emerald-600/50" : "border-border-strong bg-border-subtle",
        )}
      >
        <span
          className={cn(
