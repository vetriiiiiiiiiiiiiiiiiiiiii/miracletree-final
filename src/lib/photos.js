...
const dims = {
  ...
  "gallery-14": [1280, 853],
  "gallery-15": [1271, 953],
  "gallery-16": [1600, 1200],
  "gallery-17": [1600, 721],
  "gallery-18": [1600, 1066],
  "gallery-19": [1600, 1200],
  "gallery-20": [1024, 783],
  "gallery-21": [1280, 583],
  "gallery-22": [1024, 768],
  "gallery-23": [1500, 1000],
  "gallery-24": [1280, 576],
  "gallery-25": [1280, 960],
  "gallery-26": [1280, 853],
  "gallery-27": [1380, 920],
...
export const PHOTO_GROUPS = [
  {
    ...
    photos: [
      photo(
        "award-03",
        "An award being presented on stage at a farming awards ceremony",
      ),
  ...
  },
  {
    ...
    photos: [
      photo(
        "vip-01",
        "A MiracleTree product being presented to a visitor",
        "Former Agriculture Minister, Rajasthan",
      ),
      photo(
        "vip-02",
        "A MiracleTree bag being presented at a NABARD MABIF event",
        "NABARD, Chief General Manager — Mr Anand",
      ),
      photo(
        "vip-03",
        "A group at a MiracleTree exhibition stand",
        "Rajasthan FPO Chairman — Mr Aravind",
      ),
      photo(
        "vip-04",
        "A MOGO pack being presented to a visitor",
        "Dr Ramya, Homeopathy",
      ),
      photo(
        "vip-05",
        "A group photographed inside the MiracleTree facility",
        "EDII Periyakulam Horticulture Dean, with PhD scholar",
      ),
      photo(
        "vip-06",
        "A large group of farmers visiting the MiracleTree site at Milakaranai",
        "Farmers visiting Miracle Tree Life Science",
      ),
      photo(
        "vip-07",
        "A MiracleTree bag being presented to a visitor",
        "MABIF Chairman",
      ),
      photo(
        "vip-08",
        "A MiracleTree product being presented in an office",
        "IICPT Director and CSIR Director, Dr Anandharamakrishnan — food technology, R&D and innovation",
      ),
      photo(
        "vip-09",
        "A MiracleTree product being presented to visitors",
        "TVS Chairman, Ms Sobana",
      ),
      photo(
        "vip-10",
        "Product being shown at an exhibition stand",
        "Dr Natrajan IAS, Agriculture, Chennai",
      ),
      photo(
        "vip-11",
        "A meeting at the MiracleTree office",
  ...
  },
  {
    ...
    photos: [
      photo(
        "gallery-14",
        "The Miracle Tree Life Science building with a visiting group outside",
      ),
      photo(
        "gallery-15",
...
export const ALL_PHOTOS = PHOTO_GROUPS.flatMap((g) => g.photos);
