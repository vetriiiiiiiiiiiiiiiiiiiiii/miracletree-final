...
export type Innovation = {
  slug: string;
  year: string;
  /** The short name a person would actually say. */
  name: string;
  /** What the acronym stands for, where there is one. */
  expansion?: string;
  headline: string;
  body: string;
  /** The specific thing that makes it hard, stated plainly. */
  problem: string;
  outcome: string;
};
...
export const INNOVATIONS: Innovation[] = [
  {
    ...
    outcome: "Moringa leaf dried below the temperature at which it loses colour and quality.",
  },
  {
    slug: "mogo",
    year: "2015",
...
export const STAGES = [
  ...
  { stage: "02", title: "Process", body: "ULTCD and CLHPD — controlled drying developed in-house." },
  { stage: "03", title: "Product", body: "60+ formulations across food, nutrition and personal care." },
  { stage: "04", title: "Transfer", body: "SOPs and cultivation models given to farmers." },
  { stage: "05", title: "Global", body: "Technology partner on international moringa projects." },
];
...
export const FIGURES = [
  ...
  { value: "60+", label: "Products & formulations", note: "Food, supplements, beverages, seed oil, skin" },
  { value: "14+", label: "Countries reached", note: "Australia, USA, Canada, Spain, Germany, UK, UAE and more" },
  { value: "~405", label: "Acres farmed", note: "Research, production and contract land" },
  { value: "1.7m", label: "Trees planned in Oman", note: "Thumrait, Dhofar — phase one, 580 acres" },
  { value: "3,800", label: "Plants per acre", note: "At the densest of four cultivation models" },
];
