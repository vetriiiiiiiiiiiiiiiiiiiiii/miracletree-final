...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    { url: siteUrl("/innovation"), lastModified: now, changeFrequency: "monthly", priority: 0.7 },
    { url: siteUrl("/gallery"), lastModified: now, changeFrequency: "monthly", priority: 0.5 },
    { url: siteUrl("/track"), lastModified: now, changeFrequency: "yearly", priority: 0.4 },
