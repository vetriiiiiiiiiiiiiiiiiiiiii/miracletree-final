...
import { RitualBuilder } from "@/components/ritual/RitualBuilder";
...
const STEP_PLAN = [
  ...
  },
  {
    ...
    blurb:
      "Cold-pressed seed oil and skin drops, made from the seed rather than the leaf.",
  },
];
export default async function RitualPage() {
  ...
  const steps = STEP_PLAN.map((plan) => {
