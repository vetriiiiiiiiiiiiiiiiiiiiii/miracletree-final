    ...
    <>
      ...
      <RecordManager
        ...
        records={milestones.map((m) => ({
          ...
          badges: [
            ...
            ...(m.sourceUrl ? [{ label: "Cited", tone: "info" }] : []),
          ],
          values: {
            year: m.year,
            title: m.title,
        ...
        records={accolades.map((a) => ({
          ...
          badges: [
            a.isActive
              ...
              : { label: "Hidden", tone: "neutral" },
            a.sourceUrl
              ? { label: "Cited", tone: "info" }
              : { label: "No source", tone: "warning" },
          ],
          values: {
            kind: a.kind,
            title: a.title,
      ...
      <RecordManager
        ...
        records={credits.map((c) => ({
          id: c.id,
          title: c.name,
          subtitle: [c.role, GROUP_LABEL[c.group] ?? c.group]
            .filter(Boolean)
            .join(" · "),
          badges: [
            c.isActive
