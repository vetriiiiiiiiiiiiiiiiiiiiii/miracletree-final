                  ...
                  <Td>
                    <div className="flex items-center gap-3">
                      ...
                      <div className="min-w-0">
                        ...
                        <span className="text-xs text-cream-400">{item.variantName}</span>
                      </div>
                    </div>
                  </Td>
        ...
        <div className="grid gap-6">
          <Card title="Customer">
            {order.user ? (
              ...
              <div className="grid gap-2 text-sm">
                ...
                <a href={`mailto:${order.email}`} className="text-cream-400 hover:text-cream-100">
                  {order.email}
                </a>
          ...
          <Card title="Payment">
            <dl className="grid gap-2.5 text-sm">
              <Row
                label="Method"
                value={order.paymentProvider === "cod" ? "Cash on delivery" : "Razorpay"}
              />
